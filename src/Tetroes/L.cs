...
namespace Tetrix.Tetroes
{
    public class L : Tetro
    {
        ...
        private void CreateBlocks()
        {
            Blocks = new Block[4] 
            {
                new Block(X + 1, Y + 1, Color, '#' , _playfield.Renderer, '0'),
                new Block(X + 1, Y + 2, Color, '#' , _playfield.Renderer, '1'),
                new Block(X + 1, Y + 3, Color, '#' , _playfield.Renderer, '2'),
                new Block(X + 2, Y + 3, Color, '#' , _playfield.Renderer, '3'),
            };
        }
